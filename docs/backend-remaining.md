...
2. Repair the missing frontend steering control on fixtures and verify browser/build
   acceptance before further backend expansion; no transport wiring. Then finish
   P9 research-mode execution using existing ToolGate search capabilities.
