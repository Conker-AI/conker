...
- **Work on this task** explicitly reviews and submits its saved objective through the verified conversation pipeline. It links the actual run without automatically completing task tracking; see [live-task-dispatch.md](../archive/live-task-dispatch.md).
