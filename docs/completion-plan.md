...
P2 Activity, P3 specialist CRUD, P4 Teams/Templates, P5 Projects, P6 context controls and P7 helper-model configuration have verified preview increments. Implement P8 output retention/versioning and shared canvas next, then the authenticated backend path. Server persistence, real task/team execution and helper-model dispatch remain integration work; fixture changes still reset on reload.
