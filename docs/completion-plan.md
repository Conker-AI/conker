...
| 2026-09-20 | Protected writes and submission recovery | This increment | Fresh verification UI, deadline locking, retained request identities, reload discovery, saved preparation input and exact-message navigation. Browser checked cancelled/wrong-password attempts, mobile task verification, deadline lock and a lost committed turn acknowledgement recovered with exactly one stub-provider call. Gateway checks and production build pass. See gateway-verification-recovery.md. |
