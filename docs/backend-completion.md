...
Remaining acceptance includes team execution, linked project content assembly, direct model-provider adapters, richer attachment/research outputs, memory proposals/retention, call service behavior, bounded system effects, proactive policies and coordinated recovery. These are not satisfied by the regression count. Final frontend/backend wiring remains deferred until review.
