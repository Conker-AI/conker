...
- Use the existing semantic theme variables and density tokens. Keep custom themes and radius settings functional, full-width page gutters, and uncropped portraits.
