export const memoryFixtures = [
  {
    ...
    quote: "Judo is Tuesday and Thursday at 18:30",
  ...
  },
  {
    ...
    quote: "Two 25-minute blocks were enough to get through the questions.",
  ...
  },
  {
    ...
    age: "18 days old",
    date: "25 August 2026",
    provenance: "Your own words · one conversation, before term started",
    quote: "Я предпочитаю тренироваться перед школой.",
  ...
  },
  {
    ...
    quote: "No GPU. Text and a browser are enough for now.",
