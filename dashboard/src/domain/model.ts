...
export type Message = { id: string; sessionId: string; author: string; role: "user" | "assistant"; text: string; createdAt: string; runId?: string; replyTo?: string; actionIds?: string[]; emotion?: string; citationIds?: string[]; deleted?: boolean; delivery: "sending" | "accepted" | "unknown" };
