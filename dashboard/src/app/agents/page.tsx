...
import { AgentIdentityPortrait, DetailPanel, OverlayBody, FormActions, RecordItem, ConfirmationDialog } from "@/components/design-system"
...
export default function AgentsPage() {
  ...
  const references = selectedId ? agentReferences(data, selectedId) : []
