...
export default function ArtifactsPage(props: ArtifactScreenProps) {
  ...
  return <BaseLayout variant="collection" title="Artifacts" description="Versioned documents, code, tables, charts, diagrams and media references." status={<Badge variant="outline">Preview</Badge>} actions={<Button onClick={() => setCreating(true)} disabled={pending}><Plus />New artifact</Button>}>
