...
export const artifactKindLabels: Record<ArtifactContent["kind"], string> = { markdown: "Document", code: "Code", table: "Table", chart: "Chart", diagram: "Diagram", media: "Media", html: "HTML app" }
