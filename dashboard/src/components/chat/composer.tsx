...
export function ChatComposer({ chat }: { chat: ChatContract }) {
  ...
  return <form aria-label="Message composer" className="min-w-0 rounded-3xl border bg-card p-3 text-card-foreground shadow-composer" onSubmit={event => { event.preventDefault(); send() }}>
