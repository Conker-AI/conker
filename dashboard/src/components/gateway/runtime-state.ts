...
export function createGatewayRuntimeWorkspaceState() {
  return createStore<{
    ...
    title: string; createUnknown: 'unchecked' | 'checked' | null; operation: 'create' | 'send' | null
    reset: () => void
  }>((set, get) => ({ epoch: 0, selected: null, drafts: {}, uncertain: {}, title: '', createUnknown: null, operation: null,
    reset: () => set({ epoch: get().epoch + 1, selected: null, drafts: {}, uncertain: {}, title: '', createUnknown: null, operation: null }),
  }))
}
