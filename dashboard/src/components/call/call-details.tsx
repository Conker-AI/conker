...
export function CallDetails({ call, media, onNavigate }: { call: CallSession; media: CallMedia; onNavigate: () => void }) {
  ...
  return <div className="min-h-0 flex-1 overflow-y-auto text-sm">
    ...
    <section className="space-y-4 border-b border-border p-4">
      ...
      <p className="text-xs leading-5 text-muted-foreground">Read a reply with your browser's voice using Play on the companion's side. The visualizer shows playback activity, not measured output volume. Your character voice and real-time AI are not connected.</p>
