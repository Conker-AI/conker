...
export type RuntimeProcess = { id: string; name: string; pid: number; command: string; user: string; status: RuntimeStatus; cpuPercent: number; memoryMb: number; restarts: number; containerId?: string }
